...
echo "${PACKAGE_TO_INSTALL_LIST[@]}" # TODO: Remove this line after testing is done.
sudo apt install "${PACKAGE_TO_INSTALL_LIST[@]}" # TODO: Add -y back to this line after testing is done.
