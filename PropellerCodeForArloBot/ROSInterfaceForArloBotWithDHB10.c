// TODO for DHB-10: See notes here and inline throughout code!

// TODO for DHB-10: Run through all of the ROS by Example test scripts to see how good our odemtry is,
// TODO for DHB-10: to compare the before and after!

// TODO for DHB-10: Start here: http://learn.parallax.com/tutorials/arlo

// TODO for DHB-10: Go over EACH line and remove unneeded code relating to old way arlodrive worked
// TODO for DHB-10: Make using we are doing things the "best" way:
// TODO for DHB-10: for instance, I think there is a command for the DHB-10 to rotate in place,
// TODO for DHB-10: or to make an arc, etc. These might be more accurate than direct conversions?
// TODO for DHB-10: or possibly not. Need to experiment and plan.

// TODO for DHB-10: The ticks per count is set in arlobot.yaml under the arlobot/arlobot_bringup/param
// TODO for DHB-10: Revisit the trackwidth too.

// TODO for DHB-10: A lot of the arlo commands just call DHB-10 commands. Should we use the arlo drive still?
// TODO for DHB-10: Or make direct calls to the DHB-10?
...
// TODO for DHB-10: Can we put the download and unzip of the arlo code into setup now?

// TODO for DHB-10: Make a note in the old propeller code that it is no longer maintained!
...
*/
#include "arlodrive.h" // TODO for DHB-10: Get the new version!
// TODO for DHB-10: Document where to get everything and the example code etc.

// TODO for DHB-10: I think it is 200 now.
// TODO for DHB-10: Can we somehow "get" this from the arlodrive settings instead of defaulting it here?
...
// TODO for DHB-10: This has changed with the new controller, but we can still record it in ROS.
// TODO for DHB-10: The ticks per count is set in arlobot.yaml under the arlobot/arlobot_bringup/param
...
int main() {
    ...
    // abdrive settings:
    // TODO for DHB-10: Is this still required? Surely it is default
    drive_speed(0, 0);                     // Start servos/encoders cog
    // TODO for DHB-10: Why do we set this on the controller when we deal with max speed ourselves?
    // TODO for DHB-10: My vote right now is to remove this.
    drive_setMaxSpeed(abd_speedLimit);
    // TODO for DHB-10: My vote is to remove this and and adjust it later if we need to, otherwise let the default rule
    ...
    while (1) {
        ...
        // TODO for DHB-10: This should all work the same as before,
        // TODO for DHB-10: The only real question is whether there might be any function built
        // TODO for DHB-10: into the DHB-10 that could do some of this for us?
...
void getTicks(void) {
    ...
    // TODO for DHB-10: DHB-10 has 3 Information Request options:
    /* SPD - returns left, right motor speed in positions per second
     * HEAD - returns current heading in degrees
     * DIST - returns left, right motor accumulative distance in possitions per second
     */
    // TODO for DHB-10: So just remember that when pulling data below, the arlo library is just
    // TODO for DHB-10: running those commands.

    // TODO for DHB-10: This should work just the same, as long as we adjusted our distance per tick properly.
    drive_getTicks(&ticksLeft, &ticksRight);
    // TODO for DHB-10: getSpeedCalc is gone, replaced by only getSpeed
    // TODO for DHB-10: I don't know why we ever needed the "calc" method? Hopefully this is accurate now.
    drive_getSpeedCalc(&speedLeft, &speedRight);
    // TODO for DHB-10: The DHB-10 has a HEAD command. Is it more accurate? Seems like it would have to be.
    // TODO for DHB-10: Should I set it HERE so that we grab it as close to the time we grabbed the speed and distance as possible, and only work with "already gathered" data in displayTickes() below?
...
void displayTicks(void) {
    ...
    // TODO for DHB-10: I think we don't need this if we use HEAD from the DHB-10
    ...
    Y += deltaY;
    // TODO for DHB-10: The DHB-10 has a HEAD command. Is it more accurate? Seems like it would have to be.
    // TODO for DHB-10: Just remember to convert to Radians.
   ...
   void safetyOverride(void *par) {
    ...
    while (1) {
        if (ignoreProximity == 0) {
            ...
            safeToProceed = 1;
            safeToRecede = 1;
            // TODO for DHB-10: I think this is higher now.
            // TODO for DHB-10: Besides, these should set to a constant declared at the top of the code!
            abd_speedLimit = 100;
            abdR_speedLimit = 100;
        }
