...
var homeEvents = redis.createClient(6379, redisServer, {});
...
homeEvents.on('error', function(err) {
...
var redisChannel = 'householdevents';
homeEvents.on('message', function(channel, message) {
    ...
    if (message === 'aDoorOpened' || message === 'aDoorClosed') {
        ...
        getRedisMessages.smembers('opendoors', function(err, res) {
            if (err) {
